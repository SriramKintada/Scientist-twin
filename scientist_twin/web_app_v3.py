...
def answer_question():
    ...
    # Initialize or restore answers dictionary (more efficient than sparse array)
    if 'answers' not in session:
        print("[Quiz] Initializing answers dictionary")
        session['answers'] = {}
    ...
    # Store answer at the specific question number (dict allows sparse storage)
...
def get_matches():
    try:
        ...
        print(f"[ERROR] get_matches failed: {e}")
        import traceback
        traceback.print_exc()
