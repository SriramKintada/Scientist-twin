"""
Batch upload scientist images to Supabase from provided URLs
Run after extracting image URLs from Wikipedia using Playwright
"""
...
# Load image URLs mapping (to be created)
# Format: {"Scientist Name": "image_url", ...}
IMAGE_URLS = {}
